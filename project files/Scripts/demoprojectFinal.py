...
base_df = spark.read.text("s3://sushant1010/Demoproject/log_data_ip_request.txt")
...
clean_df.write.csv("s3://sushant1010/Demoproject/cleansedlayer/cleansed.csv",mode="overwrite")
...
curated.write.csv("s3://sushant1010/Demoproject/curatedlayer/curated.csv",mode="overwrite")
...
df_hours_getposthead_new.write.csv("s3://sushant1010/Demoproject/aggregation/perdevice/perdevice.csv",mode="overwrite")

df_hours_getposthead_new.write.mode("overwrite").saveAsTable("logsperdevice1")
...
df_across.write.mode("overwrite").saveAsTable("logsacrossdevice1")
